    ...
    shorts = [
        {
            ...
            "body_3_12s": "Секрет в формуле: ровно 15 слов на 5 секунд. Загружаете текст в наш веб-суфлер, включаете камеру прямо в браузере и читаете в идеальном ритме.",
            "cta_12_15s": "Жми ссылку в шапке, чтобы открыть суфлер бесплатно!",
            "full_teleprompter_script": (
                "Перестаньте перезаписывать ролики по 20 раз! [ПАУЗА 0.3s] "
                "Секрет в формуле: ровно 15 слов на 5 секунд. [ПАУЗА] "
                "Загружаете текст в наш веб-суфлер, включаете камеру прямо в браузере и читаете в идеальном ритме. "
                "Жми ссылку в шапке, чтобы открыть суфлер бесплатно!"
            ),
            "ffmpeg_pipeline": {
